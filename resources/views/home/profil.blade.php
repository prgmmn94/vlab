...
@section('content')
    ...
    <section class="relative w-full h-[250px] md:h-[520px] overflow-hidden">
        <img src="/images/heroprofil.jpg" class="absolute inset-0 w-full h-full object-cover" alt="Tim Lab Mamen">
        {{-- overlay gelap --}}
    ...
    <section class="text-white py-16 md:py-32" style="background:linear-gradient(to bottom,#62286C,#BF4ED2)">
        <div class="container">
            ...
            <div class="grid md:grid-cols-2 gap-8 md:gap-12">
                {{-- VISI --}}
                <div
                    class="bg-white text-gray-800 rounded-2xl p-6 md:p-10 shadow-2xl relative transform transition hover:-translate-y-1">
        ...
        <div class="container relative">
            <div class="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
                ...
                <div class="flex justify-center order-1 md:order-2">
                    <img src="/images/struktur.png" alt="Struktur Organisasi"
                ...
                <div class="swiper-wrapper !items-stretch">
                    @php
                        $staffs = [
                            [
                                'img' => 'pak yunan.png',
                                'name' => 'Dr. Muh. Yanto, SE., MM.',
                                'role' => 'Kepala Lab. Manajemen Menengah',
                            ],
                            [
                                'img' => 'pak hadir1.png',
                                'name' => 'Hadir Hidayanto, SE., MMA.',
                                'role' => 'Wakil Kepala Lab. Manajemen Menengah',
                            ],
                            [
                                'img' => 'pak darmadi.png',
                                'name' => 'Darmadi, SE., MM.',
                                'role' => 'Staff Lab. Manajemen Menengah',
                            ],
                            [
                                'img' => 'pak suwardi.png',
                                'name' => 'Suwardi, SE',
                    ...
                    @endphp
                    @foreach ($staffs as $s)
                        <div class="swiper-slide !h-auto m-4">
                            <div
                                class="h-full snap-center border border-gray-100 rounded-2xl shadow-md overflow-hidden text-center transition hover:-translate-y-2 duration-300">
                                <img src="/images/staff/{{ $s['img'] }}" class="w-full h-56 object-cover object-top"
                                    alt="{{ $s['name'] }}">
                                <div class="p-5">
