        ...
        <div class="bg-white overflow-hidden shadow-lg rounded-lg p-6">
            <form action="{{ route('admin.recruitments.update', [$recruitmentPeriod->id, $recruitment->id]) }}"
                ...
                <div class="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <p class="text-sm font-medium text-blue-900">Periode Recruitment: <span
                ...
                <div class="mt-8 flex items-center justify-end gap-x-4">
                    <a href="{{ route('admin.recruitments.index', $recruitmentPeriod->id) }}"
                        class="inline-flex text-sm font-semibold text-gray-700 hover:text-gray-900 px-4 py-2 rounded-md border border-gray-300 hover:bg-gray-50">
                    ...
                    <button type="submit"
                        class="rounded-md bg-yellow-600 px-3 py-2 text-sm font-medium text-white shadow-xs hover:bg-yellow-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-600">
                        Update
                    </button>
                </div>
            </form>
