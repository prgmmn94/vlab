                                        ...
                                        <div x-show="open" x-transition
                                            ...
                                            <div class="py-1">
                                                <a href="{{ route('admin.recruitments.download.position', [$recruitmentPeriod->id, 'programmer']) }}"
                                                    ...
                                                    Programmer
                                                    <span
                                                        class="text-xs text-gray-500">({{ $stats['programmer'] }})</span>
                                                </a>
                                                <a href="{{ route('admin.recruitments.download.position', [$recruitmentPeriod->id, 'asisten']) }}"
                                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50">
                                                    Asisten
                                                    <span
                                                        class="text-xs text-gray-500">({{ $stats['asisten'] }})</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @else
                                <div class="bg-red-50 border border-red-200 rounded-md p-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-red-700 font-medium">Tidak ada berkas yang
                                            tersedia!</span>
                                    </div>
                                </div>
                            @endif
                        ...
                        <div class="space-y-2">
                            ...
                            @if ($recruitments->total() > 0)
                                <a href="{{ route('admin.recruitments.export', $recruitmentPeriod->id) }}"
                                    ...
                                    <span class="hidden sm:inline">Ekspor Excel ({{ $recruitments->total() }}
                                        data)</span>
                            ...
                            @else
                                <div class="bg-red-50 border border-red-200 rounded-md p-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-red-700 font-medium">Tidak ada data yang
                                            tersedia!</span>
                                    </div>
                                </div>
                            @endif
