<x-admin.layout>
    <div class="space-y-6">
        ...
        <div class="bg-white overflow-hidden shadow-md rounded-lg">
            <form action="{{ route('recruitment_periods.store') }}" method="POST" class="p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="number" name="tahun" id="tahun" value="{{ old('tahun', date('Y')) }}"
                            min="2000" max="2100" step="1" placeholder="Contoh: {{ date('Y') }}"
                            required
                            class="block w-full md:w-1/3 rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 text-lg @error('tahun') border-red-500 @enderror">
                        @error('tahun')
