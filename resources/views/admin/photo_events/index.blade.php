<x-admin.layout>
    <div class="space-y-6">
        ...
        <div class="bg-white p-4 rounded-lg shadow-md mb-4">
            <form method="GET" action="{{ route('admin.photo_events.index') }}#photo-events-table">
                <div class="flex gap-2">
                    ...
                    @if (request('search'))
                        <a href="{{ route('admin.photo_events.index') }}#photo-events-table"
        ...
        {{-- Table --}}
        <div id="photo-events-table" class="bg-white overflow-hidden shadow-md rounded-lg">
                            ...
                            @forelse($photoEvents as $index => $event)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="font-medium text-gray-900">{{ $event->event_date ? \Carbon\Carbon::parse($event->event_date)->format('d M Y') : '' }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <span
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (params.has('search') || params.has('page')) {
                    const table = document.getElementById('photo-events-table');
                    if (table) {
