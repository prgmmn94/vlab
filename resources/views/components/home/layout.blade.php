...
<body>
    ...
    <button onclick="liveChat()" id="livechat">
        <a href="https://www.instagram.com/labmamen/" target="_blank"><svg class="w-10 h-10"
    ...
    <script>
        const data = {
            asisten: [{
                    ...
                    desc: 'Mengisi data diri serta mengupload berkas.',
                    status: 'upcoming',
                },
                {
                    num: 2,
                    title: 'Seleksi Tes Tertulis',
                    desc: 'Peserta mengikuti tes tertulis.',
                    status: 'upcoming',
                },
                {
                    num: 3,
                    title: 'Seleksi Tes Tutor/Materi',
                    desc: 'Peserta mengikuti tes tutor/materi.',
                    status: 'upcoming',
                },
                {
                    num: 4,
                    title: '⁠Seleksi Tes Wawancara',
                    desc: 'Peserta mengikuti tes wawancara.',
                    status: 'upcoming',
                },
                {
                    num: 5,
                    title: '⁠Seleksi Tes Wawancara Staff',
                    desc: 'Peserta mengikkuti tes wawancara bersama staff.',
                    status: 'upcoming',
                },
            ],
            programmer: [{
                ...
                {
                    num: 2,
                    title: 'Seleksi Tes Live Coding & Design',
                    desc: 'Peserta mengikuti tes tertulis.',
                    status: 'upcoming',
                },
                {
