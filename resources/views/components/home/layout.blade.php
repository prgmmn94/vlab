...
<body>
    ...
    <footer class="bg-[#0F0F0F] text-gray-400">
        ...
        <div class="md:hidden max-w-7xl mx-auto px-6 grid gap-8 pb-12 pt-16">
            ...
            <div class="space-y-4">
                ...
                <p class="text-sm leading-relaxed text-gray-400">
                    Unit kerja di Universitas Gunadarma yang menyelenggarakan praktikum dan pengembangan kompetensi
                    mahasiswa secara profesional.
                </p>

                <div class="flex gap-4 pt-2">
                    <a href="https://www.instagram.com/labmamen?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                        class="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-purple-600 hover:text-white transition-colors">
                    ...
                    <li>
                        <a href="#" class="group flex items-center gap-2 hover:text-white transition">
                            <i data-lucide="chevron-right"
                                class="w-3 h-3 text-gray-600 group-hover:text-purple-400 transition-colors"></i>
                            Modul Praktikum
                        </a>
                    </li>
                    <li>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl p-6">
                    ...
                    <div class="space-y-4 text-sm">
                        ...
                        <div class="flex gap-3 items-center">
                            ...
                            <p>0873-xxxx-xxxx <span
                                    class="text-xs font-semibold px-2 py-0.5 rounded-full bg-white/10 ml-2">Depok</span>
                            </p>
                        </div>
                        <div class="flex gap-3 items-center">
                            <i data-lucide="phone-call" class="w-4 h-4 text-gray-500 shrink-0"></i>
                            <p>0873-xxxx-xxxx <span
                                    class="text-xs font-semibold px-2 py-0.5 rounded-full bg-white/10 ml-2">Kalimalang</span>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="border-t border-white/10 md:border-white/15 py-5 md:py-6">
            <div
                class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center md:items-start md:ps-16 justify-between md:justify-start gap-2 md:gap-0 text-xs text-center md:text-left text-[#DC9A39]">
