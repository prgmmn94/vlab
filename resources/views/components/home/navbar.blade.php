<nav class="sticky top-0 z-50 w-full" x-data="{ open: false }">
    ...
    <div class="relative z-[60] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.05)] h-20">
        <div class="max-w-7xl mx-auto px-4 md:px-10 lg:px-20 h-full flex items-center justify-between">
            ...
            <ul class="hidden md:flex items-center gap-6 lg:gap-8 text-[11px] lg:text-xs font-bold">
                ...
                @foreach ($menus as $label => $data)
                    ...
                    <li class="relative group">
                        ...
                        @if ($hasSubmenu)
                            <div
                                class="absolute left-0 w-48 bg-white shadow-2xl rounded-xl py-3 mt-1
            ...
            <div x-show="open" @click="open = false" x-transition.opacity.duration.300ms
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-300 origin-top"
                ...
                x-transition:leave-start="scale-y-100 opacity-100" x-transition:leave-end="scale-y-0 opacity-0"
                            ...
                            <li>
                                @if ($hasSubmenu)
                                    ...
                                    <details class="group [&_summary::-webkit-details-marker]:hidden"
                                        {{ $isActive ? 'open' : '' }}>
                                        <summary
                                            class="group flex items-center justify-between rounded-xl px-4 py-3 text-gray-500 hover:bg-gray-100 hover:text-gray-700 cursor-pointer">
                                            <div class="flex items-center gap-3">
