<div id="sidebar"
    ...
    <nav class="mt-8 px-4 pb-32 overflow-y-auto h-[calc(100vh-8rem)]">
        <div class="space-y-2">
            ...
            <!-- Layanan Section -->
            @if (Auth::user()->role === 'Super Admin' || Auth::user()->role === 'Operation Admin')
                <div class="pt-4 mt-4 border-t border-blue-400 border-opacity-30">
                ...
                <div class="pt-4 mt-4 border-t border-blue-400 border-opacity-30">
                    ...
                    <div class="mt-2 space-y-2">
                        ...
                        <a href="{{ route('admin.experiences.index') }}"
                            class="group flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('admin.experiences.*') ? 'bg-white bg-opacity-20 text-white' : 'text-blue-100 hover:bg-white hover:bg-opacity-10 hover:text-white' }} transition-colors duration-200">
                            <svg class="mr-3 h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="M14.138 15.288q.937-.713 1.362-1.838h-7q.425 1.125 1.363 1.838T12 16t2.138-.712m-3.576-3.726Q11 11.126 11 10.5t-.437-1.062T9.5 9t-1.062.438T8 10.5t.438 1.063T9.5 12t1.063-.437m5 0Q16 11.125 16 10.5t-.437-1.062T14.5 9t-1.062.438T13 10.5t.438 1.063T14.5 12t1.063-.437M7.625 6.4l2.8-3.625q.3-.4.713-.587T12 2t.863.188t.712.587l2.8 3.625l4.25 1.425q.65.2 1.025.738t.375 1.187q0 .3-.088.6t-.287.575l-2.75 3.9l.1 4.1q.025.875-.575 1.475t-1.4.6q-.05 0-.55-.075L12 19.675l-4.475 1.25q-.125.05-.275.063T6.975 21q-.8 0-1.4-.6T5 18.925l.1-4.125l-2.725-3.875q-.2-.275-.288-.575T2 9.75q0-.625.363-1.162t1.012-.763zM8.85 8.125L4 9.725L7.1 14.2L7 18.975l5-1.375l5 1.4l-.1-4.8L20 9.775l-4.85-1.65L12 4zM12 11.5" />
                            </svg>
                            Pengalaman
                        </a>
